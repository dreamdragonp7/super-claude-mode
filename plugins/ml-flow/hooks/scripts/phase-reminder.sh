    ...
    cat << EOF
{
  "hookSpecificOutput": {
    ...
    "additionalContext": "ML-FLOW REMINDER: You are currently in ${CURRENT_PHASE}. Always announce the phase at the start of your response using the format: **Phase X of 12: [Phase Name]** followed by Next: Phase Y - [Next Phase Name]"
  }
}
EOF
else
    ...
    cat << EOF
{
  "hookSpecificOutput": {
    "hookEventName": "UserPromptSubmit",
    "additionalContext": "ML-FLOW: If this is an /ml-flow task, ensure you announce phases using: **Phase X of 12: [Phase Name]** at the start of each phase."
  }
}
EOF
fi
