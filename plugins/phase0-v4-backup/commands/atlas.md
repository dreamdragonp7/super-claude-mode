...
|---------|------|----------|----------|--------|
| auth | full-stack | 5/5 ✓ | 2/3 | ✅ |
| payments | full-stack | 3/5 | 0/3 | ⚠️ |
| trajectory | api-only | 3/3 ✓ | 1/1 ✓ | ✅ |
...
```
📚 Atlas Documentation Generated
───────────────────────────────────────

docs/repo-map.md
├── Project type: pnpm monorepo
├── Entry points: 3 (API, Web, Mobile)
├── Key modules: 4
└── Config files: 5
